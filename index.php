...
<li>AB positive or AB negative.</li>
                ...
                <p>A healthy diet helps ensure a successful blood donation, and also makes you feel better! Check out the following recommended foods to eat prior to your donation:
				<ul>
                
                
				<li>Iron-rich foods</li>
				<li>Foods rich in Vitamin C</li>
				<li>Whole grains</li>
				<li>Fluids</li>
								</ul> 

Ensure your meal is balanced and includes a combination of carbohydrates, protein, healthy fats, vitamins, and minerals. </p>
            </div>
            <div class="col-lg-6">
